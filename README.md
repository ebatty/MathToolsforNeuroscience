...
|  |    [Video 1.2: Vector properties & operations](https://youtu.be/YBCLN8NnrjM)                        |  Vector length, unit & zero vectors, scalar multiplication, vector addition, dot product, neuroscience example|
