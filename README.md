...
|  |    [Video 1.2: Vector properties & operations](https://youtu.be/7AXpa4U4j-M)   <br> [Notes](https://github.com/ebatty/MathToolsforNeuroscience/blob/updates/Week1/video12_notes.pdf)                        |  Vector length, unit & zero vectors, scalar multiplication, vector addition, dot product, neuroscience example|
